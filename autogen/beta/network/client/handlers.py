...
async def _process_substantive(envelope: Envelope, client: "AgentClient") -> None:
    ...
    try:
        ...
        try:
            ...
            # used by the workflow adapter when routing handoffs. Both Hub
            # and HubClient expose ``_name_to_id``; pass the in-process hub
            # when available (full population), else the wire-mode client.
