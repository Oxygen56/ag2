...
* ``cancel``   — peer asks the owner to cancel via ``ag2.task.cancel_request``.
    ...
    async def tasks(
        ...
        *,
        ...
        if action == "cancel":
            ...
            # owner's channel so they can decide whether to honour it.
            ...
            if meta.channel_id is None:
                return (
                    ...
                    "cancel_request needs a channel to deliver into"
                )
            envelope = Envelope(
